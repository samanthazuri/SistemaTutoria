...
<!-- barra de navegaccion -->
  ...
  <div class="collapse navbar-collapse" id="navbarSupportedContent">
    <ul class="navbar-nav mr-auto">
        ...
        <li class="nav-item dropdown">
        <a  class="nav-link dropdown-toggle" data-toggle = "dropdown"  role="button"arian-haspopup="true" aria-expanded ="false" href="#">Seguimiento de actividades</a>
        <div  class="dropdown-menu" aria-labelledby="navbarDropdown">
        <a id="incritosle" href="../Vista/alumnosIngles.html" class="dropdown-item" href="#">Lenguas extranjeras</a>
        <a id="mostrar" class="dropdown-item" href="#">Actividades complementarias</a>          
      </li>
